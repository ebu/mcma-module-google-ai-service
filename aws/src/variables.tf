...
variable "google_credentials_file" {
  type        = string
  description = "Credentials file for service account generated by google cloud console"
}

variable "google_bucket_name" {
  type        = string
  description = "Google bucket to be used for temp files"
}

variable "google_bucket_location" {
  type        = string
  description = "Google bucket location"
}
...
variable "config_bucket" {
  ...
  description = "Optional bucket for storing config file"
  default     = null
}
